...
const Room = ({offers}: RoomProps): JSX.Element => {
  const { id } = useParams();
  const currentOffer: Offer = offers.find((offer: Offer) => offer.id === Number(id)) ?? offers[0];
        ...
        <section className="property">
          <div className="property__gallery-container container">
            <div className="property__gallery">
              {currentOffer.images.map((img: string, count: number): JSX.Element => (
            ...
            <div className="property__wrapper">
              ...
              <div className="property__rating rating">
                <div className="property__stars rating__stars">
                  <span style={{width: `${((currentOffer.rating / 5) * 100).toFixed()}%`}}></span>
              ...
              <div className="property__host">
                ...
                <div className="property__host-user user">
                  ...
                  {currentOffer.host.isPro ? getUserStatus() : ''}
                </div>
